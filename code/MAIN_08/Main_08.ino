...
String createSETUPhtml(){
  ...
  HTMLsetup += "If you want to assign a static IP address to the light, the next three fields MUST be populated, otherwise leave blank.<br>";
  HTMLsetup += "Static IP(optional):<input type=\"text\" name=\"sip1\" value = \"\" pattern=\"^(?:[0-9]{1,3}.){3}[0-9]{1,3}$\" placeholder=\"xxx.xxx.xxx.xxx\"><br>";
  HTMLsetup += "Gateway IP(optional):<input type=\"text\" name=\"gate1\" value = \"\" pattern=\"^(?:[0-9]{1,3}.){3}[0-9]{1,3}$\" placeholder=\"xxx.xxx.xxx.xxx\"><br>";
  HTMLsetup += "Subnet Mask(optional):<input type=\"text\" name=\"subnet1\" value = \"\" pattern=\"^(?:[0-9]{1,3}.){3}[0-9]{1,3}$\" placeholder=\"xxx.xxx.xxx.xxx\"><br><br>";
  ...
  HTMLsetup += "Switcher IP Address:<input type=\"text\" name=\"ip\" value = \"\" required pattern=\"^(?:[0-9]{1,3}.){3}[0-9]{1,3}$\" placeholder=\"xxx.xxx.xxx.xxx\">";
  HTMLsetup += "Switcher Port:<input type=\"text\" name=\"port\" value = \"4444\" id=\"portField\" required pattern=\"[0-9]{1,4}\"><br><br>";
  HTMLsetup += "Switcher Password (if used):<input type=\"text\" name=\"pswd\" value = \"\"><br>";
...
String createACKhtml(){
  ...
  if (wifi_sip.length() == 0) {
    HTMLsetup += "TallyPro IP address will be dynamically assigned<br>";
  }else{
    HTMLsetup += "<b>TallyPro Static IP Address: </b>" + wifi_sip + "<br>";
    HTMLsetup += "<b>TallyPro Gateway Address: </b>" + wifi_gateway + "<br>";
    HTMLsetup += "<b>TallyPro Subnet Mask: </b>" + wifi_subnet + "<br><br>";
  }
  switch(Switch_Type){
    case 0:
  ...
  HTMLsetup += "<b>Switcher IP Adress: </b>" + Switch_IP + "<br>";
  HTMLsetup += "<b>Switcher Port: </b>" + Switch_Port + "<br>";
